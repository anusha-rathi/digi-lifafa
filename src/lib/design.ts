...
const T = {
  hi: {
    ...
    shareKeep: 'यह पेज सहेज लीजिए, अपने लिफ़ाफ़े तक वापस आने का यही रास्ता है। ऊपर वाला लिंक वो खोलेंगे।',
  ...
  hn: {
    ...
    borderHint: 'kinara', motifHint: 'beech ka buta',
  ...
  en: {
    ...
    borderHint: 'border', motifHint: 'centre motif',

...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      { h: "Sukhkarta Dukhharta lyrics in Marathi" },
      { h3: "Verse 1" },
      ...
      { p: "जय देव जय देव जय मंगलमूर्ती । दर्शनमात्रे मनकामना पुरती ॥" },
      { h3: "Verse 3" },
      ...
      { note: "Roman spellings vary because Marathi sounds do not map perfectly to English letters. Use the transliteration as a prompt, not as a replacement for listening to a fluent Marathi singer." },

      { h: "The plain meaning in one minute" },
      { p: "The first verse says: you create happiness, take away sorrow and remove the very account of obstacles. Your love and grace fill what is lacking. Your beautiful form is covered in shendur, and a pearl necklace shines at your throat." },
      { p: "The refrain says: victory to you, auspicious form. At the sight of you, the wishes held in the mind find fulfilment." },
      { p: "The second verse looks closely at the deity: Gauri's son beneath a jewel-studded canopy, anointed with sandalwood, kumkum and saffron, wearing a diamond-set crown and anklets that ring at his feet." },
      { p: "The third verse names Ganesha through his body and attributes: Lambodar, the large-bellied one; clad in yellow; adorned with a serpent; with a curved trunk and three eyes. Then the poet enters the song: Ramdas waits at home. Come in crisis, protect at the final passage, O one worshipped by the gods." },

      { h: "Line-by-line meaning: first verse" },
      { h3: "Sukhakarta dukhaharta" },
      { p: "Sukhakarta is the one who brings or makes sukha, happiness and well-being. Dukhaharta is the one who takes away dukha, sorrow or suffering. The line is balanced on purpose: Ganesha is approached both for what we hope will enter life and for what we hope can be removed." },
      { h3: "Varta vighnachi, nuravi puravi prem krupa jayachi" },
      { p: "Vighna means obstacle. 'Varta vighnachi' points toward the very news or trace of obstacles. 'Nuravi' carries the sense of causing them to vanish; 'puravi' of fulfilling or providing. The subject of the grace is Ganesha: his love and mercy remove obstacles and fill what is needed." },
      { p: "This line is often sung from memory with compressed syllables. One published Marathi commentary specifically notes that nuravi is commonly distorted. If your family version differs, do not stop the aarti to correct an elder. Check a reliable printed text later and learn the line calmly." },
      { h3: "Sarvangi sundar uti shendurachi" },
      { p: "Sarvangi means across the whole body; sundar, beautiful. Uti is the fragrant or ceremonial paste applied to the deity. Shendur is the orange-red vermilion strongly associated with Ganesha images in Maharashtra. The poet is not offering an abstract adjective. He is looking at the visible, worshipped form." },
      { h3: "Kanthi jhalake maal muktaphalanchi" },
      { p: "At the kanthi, the neck, gleams a garland of muktaphal, pearls. Jhalake is the flash or gleam that makes the image feel present under the aarti light. The verse moves from Ganesha's work in a devotee's life to the sensory act of darshan." },

      { h: "What the refrain means" },
      { p: "'Jai Dev' is praise: victory or glory to the deity. Mangalmurti is the auspicious form, a name especially loved in the chant 'Mangal Murti Morya'. 'Darshanmatre' means by darshan alone; 'manakamana purti' means the fulfilment of the heart or mind's wish." },
      { p: "Aarti language is devotional poetry, not a contract. The line does not mean every passing desire must arrive exactly as imagined because the lamp circled once. Darshan changes the person who stands before the deity. Fulfilment in a bhakti song includes being steadied, redirected and brought near, not only receiving an item requested." },
      { p: "Repeat the refrain after every verse. In a group, a lead singer may begin the line and everyone joins. Keep the lamp's movement steady and away from loose synthetic decoration, children's hair and sleeves. The person holding the plate should be able to see the flame, not read from a phone held directly above it." },

      { h: "Line-by-line meaning: second verse" },
      { h3: "Ratnakhachit phara tujh Gaurikumara" },
      { p: "Ratnakhachit means set or studded with jewels. Phara is read as the ornamental canopy or forehead ornament in published explanations. Gaurikumara means son of Gauri, another name for Parvati. The line places Ganesha inside his family identity rather than naming him only through power." },
      { h3: "Chandanachi uti kumkum-keshara" },
      { p: "The deity is anointed with sandalwood, kumkum and kesar, saffron. These are materials of worship, fragrance and colour. A home singing the aarti does not need to possess every material named in the poetry. The verse describes the beautifully adorned form before the singer." },
      { h3: "Hirejadit mukut shobhato bara" },
      { p: "A diamond-set crown suits him beautifully. Shobhato means it shines, looks fitting or appears splendid. Again the gaze travels over the image in front of the lamp." },
      { h3: "Runjhunati nupure charani ghagariya" },
      { p: "Nupur and ghagariya are anklets and small bells at the feet. Runjhunati imitates their ringing. The line gives sound to a form that otherwise stands still, as if Bappa has just arrived and the house can hear the steps." },

      { h: "Line-by-line meaning: third verse" },
      { h3: "Lambodar pitambar phanivaravandana" },
      { p: "Lambodar names the large-bellied form of Ganesha. Pitambar is the yellow garment. Phanivar points to the noble serpent; translations differ over the exact grammatical relation, commonly describing a serpent ornament or girdle. Do not turn an uncertain compound into an elaborate invented story." },
      { h3: "Saral sond, Vakratunda, Trinayana" },
      { p: "Sond is the trunk. Vakratunda, the curved-trunked one, is one of Ganesha's familiar names. Trinayana means three-eyed. The third eye is unusual in many modern Ganesha images but appears in explanations connecting the aarti to Mayureshwar at Morgaon. This is one of the strongest clues that the song's visual details are not generic." },
      { h3: "Das Ramacha vaat pahe sadana" },
      { p: "This is the poet's signature. 'Das Ramacha' identifies Ramdas, servant of Rama; 'vaat pahe sadana' says he waits at his dwelling. It should not be flattened into an unnamed devotee waiting. Samarth Ramdas places himself at the door, awaiting Ganesha." },
      { h3: "Sankati pavave, nirvani rakshave, suravaravandana" },
      { p: "Come to me in sankat, crisis. Protect me at nirvana or the final passage. Suravaravandana addresses the one worshipped by the foremost gods. The aarti ends on a heavier request than its popular festive tune may suggest: not only make this celebration happy, but remain present in difficulty and at the end of life." },
      ...
      { h: "What YouTube ranking reveals" },
      { p: "This is one of the largest Ganesh devotional search clusters on YouTube. In a search checked on 20 September 2026, a Wings Marathi upload had more than 131 million views, Nova Marathi Bhakti more than 98 million, a Sadhana Sargam version more than 88 million, Rajshri Soul more than 40 million and the Lata Mangeshkar recording on Saregama nearly 15 million." },
      { p: "Those numbers show durable demand for the aarti itself. The titles repeat the same search language: 'Sukhkarta Dukhharta', 'Ganpati Aarti', 'full aarti', 'Marathi', 'lyrics'. Meaning-focused videos are much smaller, from a few thousand to tens of thousands of views. That gap is exactly why a written guide should not publish lyrics alone. People need to know what they are saying." },
      { p: "A high-ranking recording is evidence of how people listen, not authority for every spelling shown on screen. Compare lyrics with a reputable printed or reference text. Music labels can own a recording of a seventeenth-century composition even though they did not write the underlying aarti, so embed or link lawfully rather than copying audio." },

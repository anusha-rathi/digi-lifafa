...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      { h: "Shendur Lal Chadhayo lyrics in Devanagari" },
      { h3: "Verse 1" },
      ...
      { p: "जय जय श्री गणराज विद्या सुखदाता । धन्य तुम्हारा दर्शन मेरा मन रमता ॥" },
      { h3: "Verse 3" },
      { p: "भावभगत से कोई शरणागत आवे । संतति संपत्ति सभी भरपूर पावे । ऐसे तुम महाराज मोको अति भावे । गोसावीनंदन निशिदिन गुण गावे ॥३॥" },
      { p: "जय जय श्री गणराज विद्या सुखदाता । धन्य तुम्हारा दर्शन मेरा मन रमता ॥" },
      { note: "Several words vary in print and singing. Treat this as a clean widely circulating version, not a claim that every regional booklet is wrong." },
      ...
      { p: "Roman text cannot hold every Hindi and Marathi sound. Chadhayo is not chad-ha-yo; sing it closer to cha-rhaa-yo. Listen to a fluent recording while following the Devanagari text." },

      { h: "The meaning in one minute" },
      { p: "The first verse sees Ganesha covered in red shendur: the splendid elephant-faced, large-bellied son of Gauri and Har, holding a jaggery laddoo. His greatness cannot be fully spoken, so the singer bows at his feet." },
      { p: "The refrain praises Ganraj, lord of the ganas, as giver of knowledge and happiness. His darshan is blessed; the singer's mind rests or delights in it." },
      { p: "The second verse says the eight siddhis serve him, crises meet their enemy in him, and he holds authority as the auspicious destroyer of obstacles. His form shines like millions of suns. The remaining image describes the temples of his head and a moon-like ornament, but this densely poetic line varies in spelling and translation." },
      { p: "The third verse welcomes whoever comes to refuge with bhava and bhakti. It asks for fullness of family and prosperity, says the Maharaj is deeply beloved, and closes with Gosavinandan singing his qualities day and night." },

      { h: "Line-by-line meaning: the first verse" },
      { h3: "Shendur lal chadhayo achchha gajmukh ko" },
      { p: "Red shendur has been offered to the beautiful elephant-faced one. Shendur is the orange-red vermilion applied to many Ganesha forms in Maharashtra. The verb chadhayo reflects a north Indian or Rajasthani-Hindi devotional register: it has been offered or applied." },
      { h3: "Dondil lal biraje sut Gauri-Har ko" },
      { p: "The beloved large-bellied one sits in splendour, son of Gauri and Har, meaning Parvati and Shiva. Dondil is not everyday standard Hindi; printed versions split or modernise it differently. The visual point is Lambodar, the full-bellied Ganesha seated before the singer." },
      { h3: "Haath liye gud-laddu" },
      { p: "He holds a jaggery laddoo. Search pages often replace gud-laddu with modak because modak is strongly associated with Ganesha. Do not silently rewrite the lyric. The aarti names a gud sweet in this line; households can still offer their customary modak, laddoo, fruit or other naivedya." },
      { h3: "Mahima kahe na jaay, lagat hoon pad ko" },
      { p: "His greatness cannot be fully described; the singer falls at or clings to his feet. Aarti moves from ornament and food to surrender in four lines. That is why translating only the noun list misses the verse." },

      { h: "What the refrain means" },
      { p: "Ganraj is king or lord of the ganas. Vidya sukhdata is the giver of learning and well-being. 'Dhanya tumhara darshan' calls the sight of him blessed. 'Mera man ramta' says the mind delights, rests or becomes absorbed there." },
      { p: "Ramta is more than 'I like looking at the idol'. It suggests the mind finds a place to dwell. During a loud festival aarti, that quiet idea can disappear under cymbals. Pause long enough to know what the refrain asks: let attention stop scattering and rest in darshan." },
      { p: "Repeat the refrain after each verse. A lead singer can carry the unfamiliar verse while everyone joins here. If the group knows only the film refrain, print the complete text before puja rather than improvising around the lamp." },

      { h: "Line-by-line meaning: the second verse" },
      { h3: "Ashtau siddhi daasi" },
      { p: "The eight siddhis, extraordinary attainments named in yoga and devotional traditions, are pictured as attendants. The poetry places powers beneath Ganesha rather than making power itself the goal of worship." },
      { h3: "Sankat ko bairi, vighna-vinashan" },
      { p: "He is the enemy of crisis and destroyer of obstacles. This is the aarti's clearest connection to Vighnaharta. It does not promise a life with no difficulty; the devotional stance is that obstacles are met under his protection and intelligence." },
      { h3: "Mangal-murat adhikari" },
      { p: "He is the rightful bearer or lord of the auspicious form. Murat is the vernacular form of murti. The line belongs beside the Maharashtrian name Mangalmurti, even though this aarti's language is not straightforward modern Marathi." },
      { h3: "Koti suraj prakash, aisi chhavi teri" },
      { p: "Your appearance shines with the light of millions of suns. Koti can mean ten million and also functions poetically as an immeasurable multitude. Do not turn the line into a scientific luminosity claim; it is a comparison for radiance." },
      { h3: "Gandasthal madmastak..." },
      { p: "Gandasthal means the temple or cheek area of the elephant head. Madmastak evokes the powerful, exhilarated elephant. The final word is printed as Shashibihari or close variants and is translated inconsistently. The honest reading is that the verse continues the radiant elephant-form imagery; claims beyond that need a source more stable than copied lyric pages." },

      { h: "Line-by-line meaning: the third verse" },
      { h3: "Bhav-bhagat se koi sharanagat aave" },
      { p: "Whoever comes to refuge with feeling and devotion is welcomed. Bhagat is a vernacular form linked to bhakta or bhakti. Sharanagat means one who has come to shelter. The line opens the song outward: not only a ritual expert, but anyone arriving sincerely." },
      { h3: "Santati sampatti sabhi bharpur paave" },
      { p: "May they receive fullness of family continuity and prosperity. Like many older devotional lines, it speaks from a world where descendants and household resources were central signs of security. It should not be used to tell a childless or poor person that devotion is deficient." },
      { h3: "Aise tum Maharaj moko ati bhaave" },
      { p: "Such are you, Maharaj, deeply dear to me. Moko means to me, an older Braj or western-Hindi form. The register shifts across regions, one clue that the aarti travelled through oral performance rather than being composed in today's standard textbook Hindi." },
      { h3: "Gosavinandan nishidin gun gaave" },
      { p: "Gosavinandan sings your qualities day and night. This appears to be a signature, but widely available pages do not agree on the identity behind it. It is safer to preserve the name than to invent a biography from the resemblance to Morya Gosavi." },
      ...
      { p: "The 1999 Hindi film Vaastav placed Shendur Lal Chadhayo inside a memorable Ganesh festival sequence. Current YouTube uploads tied to the film have extraordinary reach: a T-Series version has more than 75 million views, another official lyrical upload more than 49 million, and a Hindi-English lyrics upload more than 7 million as of 20 September 2026." },
      ...
      { p: "Standalone devotional uploads also rank strongly. Nova Spiritual India's performance had more than 92 million views, while other lyrical versions had millions. Titles cluster around 'Shendur Lal Chadhayo', 'Ganesh Aarti', 'Vaastav', 'lyrics' and spelling variants such as Sindoor Lal. A useful blog should include those search spellings but keep the displayed text coherent." },

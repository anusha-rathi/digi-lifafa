...
export const metadata: Metadata = {
  ...
  description: "What Digi Lifafa stores, what it doesn't, and how to get it deleted.",
};

export default function Privacy() {
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-5 py-14">
      <h1 className="font-display text-4xl text-maroon">Privacy policy</h1>
      <p className="mt-2 text-sm text-ink-faint">Last updated 24 August 2026</p>

      <div className="prose mt-8">
        <p>
          The short version: there are no accounts, we collect the minimum
          needed to draw your envelope, and we never see your money.
        </p>
        ...
        <p>
          ...
          the way you would treat the envelope: give it to the person it&apos;s
          for.
        </p>
        <p>
        ...
        <p>
          ...
          exception would be a lawful order from a competent authority, or where
          we must act on a report of abuse.
        </p>

...
export default function Terms() {
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-5 py-14">
      <h1 className="font-display text-4xl text-maroon">Terms &amp; conditions</h1>
      <p className="mt-2 text-sm text-ink-faint">Last updated 24 August 2026</p>

      <div className="prose mt-8">
        <h2>1. What this service is</h2>
        <p>
          Digi Lifafa lets you create a decorated digital envelope and share it
          as a link. It is a greeting and gifting product. By using it you agree
          to these terms.
        </p>
        ...
        <p>
          <strong>
            Digi Lifafa does not process, hold, route, transfer or refund money.
          </strong>{" "}
          We are not a bank, a payment aggregator, a payment gateway, a wallet
          or a money transfer service, and we do not act as an agent for either
          party to a payment.
        </p>
        <p>
        ...
        <p>
          We cannot reverse, cancel, refund or trace any payment. For a disputed
          or mistaken payment, contact your bank and use the NPCI dispute
          redressal process.
        </p>
        ...
        <p>
          You keep ownership of what you write. You grant us only the permission
          needed to store and display it to whoever opens your link. You are
          responsible for what you write, and you confirm you have the right to
          send it.
        </p>
        <p>
        ...
        <p>
          ...
          from a payment you make or fail to make, a payment sent to the wrong
          recipient, a lifafa link being shared onward, or the service being
